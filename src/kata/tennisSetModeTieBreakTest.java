...
public class tennisSetModeTieBreakTest {
	...
	public tennisSetModeTieBreakTest(int player1Game, int player2Game, int player1Point, int player2Point, String expectedResult) {
	...
	@Parameters
	 public static Collection<Object[]> getAllScores() {
	        return Arrays.asList(new Object[][] {
	                ...
	                { 7, 0, 0, 0, "Player1 wins"},
	                { 7, 1, 0, 0, "Player1 wins"},
	                { 7, 2, 0, 0, "Player1 wins"},
	                { 7, 3, 0, 0, "Player1 wins"},
	                { 7, 4, 0, 0, "Player1 wins"},
	                { 7, 5, 0, 0, "Player1 wins"},
	                
	                { 6, 5, 1, 2, "Set: 6-5 Game: Fifteen-Thirty"},
	                { 6, 5, 1, 3, "Set: 6-5 Game: Fifteen-Forty"}, 
	                { 6, 5, 1, 4, "Set: 6-5 Game: Player2 wins => Set: 6-6"},
	                
	                { 6, 6, 2, 1, "Set: 6-6 Game: Thirty-Fifteen"},
	                { 6, 6, 3, 1, "Set: 6-6 Game: Forty-Fifteen"}, 
	                { 6, 6, 4, 1, "Set: 6-6 Game: Player1 wins => Set: 7-6"},
	                
	                { 7, 6, 2, 1, "Set: 7-6 Game: Thirty-Fifteen"},
	                { 7, 6, 3, 1, "Set: 7-6 Game: Forty-Fifteen"}, 
	                { 7, 6, 4, 1, "Set: 7-6 Game: Player1 wins => Set: 8-6 Player1 wins"},
	        });
	    }
	 
	 public void checkAllScores(TennisSet set, TennisGame game) {
	        String result = set.getResultModeTieBreak(set,game, player1Game, player2Game, player1Point, player2Point);
