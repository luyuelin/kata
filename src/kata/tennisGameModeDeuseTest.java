...
public class tennisGameModeDeuseTest {
	private int player1Point;
	private int player2Point;
	private String expectedResult;
	
	public tennisGameModeDeuseTest(int player1Point, int player2Point, String expectedResult) {
	 ...
	 public void checkAllScores(TennisGame game) {
	        ...
	        assertEquals(this.expectedResult, game.getResultModeDeuse());
	        System.out.println("Result: " + game.getResultModeDeuse());
	        System.out.println();
	    }   
